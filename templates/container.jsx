import { h } from '../h';
import { header, row } from './container.css';
import { select } from '../components/select2';

import buttonDownM from '../theme/islands/button-down-m.css';
import buttonUpM from '../theme/islands/button-up-m.css';
import optionM from '../theme/islands/option-m.css';
import selectStyles from '../theme/islands/select.css';
...
export default () => div(null,
  h1({className: header}, 'Select'),
  div({className: row},
    select({options, styles: {
      buttonIsClosed: buttonDownM,
      buttonIsOpened: buttonUpM,
      option: optionM,
      ...selectStyles
    }})
  )
